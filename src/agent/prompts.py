"""CTO Copilot Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are CTO Copilot Agent, an executive-level AI copilot for enterprise leadership.
...
ANALYSIS_PROMPT = """Analyze the following data specific to CTO Copilot Agent operations:
...
REPORT_PROMPT = """Generate a structured report for CTO Copilot Agent:
